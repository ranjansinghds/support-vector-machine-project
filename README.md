...
## 📌 Overview
This project explores the **Support Vector Machine (SVM)** algorithm for classification tasks. The goal is to predict target labels based on various features using SVM with different kernels. The dataset is preprocessed, visualized, and used to train multiple SVM models to compare their performance.
...
```bash
git clone https://github.com/ranjansinghds/support-vector-machine-project
cd support-vector-machine-project
```
...
- **A pairplot of the data set. Which flower species seems to be the most separable**: ![Most separable](https://github.com/ranjansinghds/support-vector-machine-project/blob/main/Support%20Vector%20Machine%20Project%20png/pairplot%20for%20which%20flower%20species%20seems.png)
- **A kde plot of sepal_length versus sepal width for setosa species of flower**: ![setosa species of flowers](https://github.com/ranjansinghds/support-vector-machine-project/blob/main/Support%20Vector%20Machine%20Project%20png/kde%20plot%20of%20sepal_length%20versus%20sepal_width.png)
